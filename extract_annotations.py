...
def parse_parameters(parser=None):
    ...
    ## Required
    parser.add_argument("--input_ann", default="./cadec_dataset/original", type=str)
    parser.add_argument("--input_text", default="./cadec_dataset/text", type=str)
    parser.add_argument("--output_filepath", default="./ann", type=str)
        ...
        for document in os.listdir(args.input_ann):
            with open(os.path.join(args.input_ann, document), "r") as in_f:
                ...
                for line in in_f:
                    ...
                    # entity type and entity indexes
                    sp = sp[1].split(" ")
                    label = sp[0]   # entity type
                    ...
                    num_annotations += 1
                    # document_name, entity type, entity indexes, mention
